...
@Metadata.ignorePropagatedAnnotations: true
define view entity ZI_TRAVEL_TECH_M_AUG1
  ...
  association [0..1] to /DMO/I_Overall_Status_VH_Text as _Overall_Status on $projection.OverallStatus = _Overall_Status.OverallStatus
{
